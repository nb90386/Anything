...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[10rem] overflow-hidden rounded-lg border border-ink-100 bg-white p-1 shadow-elevated",
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[12rem] overflow-hidden rounded-lg border border-ink-100 bg-white p-1 shadow-elevated animate-fade-in",
        "dark:border-ink-800 dark:bg-ink-900",
        className
      )}
      {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center gap-2 rounded-md px-2 py-1.5 text-sm text-ink-700 outline-none transition-colors",
      "focus:bg-ink-100 focus:text-ink-900 dark:text-ink-200 dark:focus:bg-ink-800 dark:focus:text-white",
...
function DropdownMenuLabel({
  ...
  return (
    <div
      className={cn("px-2 py-1.5 text-xs font-semibold uppercase tracking-wide text-ink-400", inset && "pl-8", className)}
      {...props}
    />
  );
}
...
function DropdownMenuSeparator({ className, ...props }: ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Separator>) {
  return <DropdownMenuPrimitive.Separator className={cn("-mx-1 my-1 h-px bg-ink-100 dark:bg-ink-800", className)} {...props} />;
}
